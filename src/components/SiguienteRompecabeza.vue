<template>
  ...
  const imageUrl = 'https://m.media-amazon.com/images/I/81rnjXkiIzL._AC_UF894,1000_QL80_.jpg'; // Imagen genérica
  ...
  const verificarGanador = () => {
    ...
    if (isWinner) {
      ...
      setTimeout(() => {
        ...
        //router.push('/otro-rompecabezas'); // Redirigir a otro rompecabezas
